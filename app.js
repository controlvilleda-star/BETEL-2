  ...
  entries: [
    {
      ...
      lemma: 'palabra',
      short: 'Palabra, expresión, o el Verbo divino.',
      definition: 'Una palabra dictada, una declaración; por implicación, un tema, discurso o razón. Especialmente usado para Cristo como el Verbo de Dios.',
      beginner: 'Significa palabra, mensaje o razón. En Juan 1, se refiere a Jesús como el mensaje vivo de Dios.',
      advanced: 'Sustantivo masculino. Puede referirse al acto de hablar, al contenido del habla, o a la razón misma.',
      morphology: 'sustantivo masculino',
      tags: ['palabra', 'verbo', 'razón'],
      related: ['G4487'],
      caution: 'No se limita solo a una palabra hablada; abarca la idea y la expresión.',
      starter: true,
    },
    {
      id: 'G4151',
      ...
      lemma: 'espíritu',
      short: 'Espíritu, viento o aliento.',
      definition: 'Aliento, viento, brisa. El Espíritu Santo de Dios, o el espíritu humano.',
      beginner: 'Puede significar viento, aliento o espíritu. Normalmente se usa para el Espíritu Santo.',
      advanced: 'Sustantivo neutro. Fundamental en la teología del NT para la agencia divina y la vida en el creyente.',
      morphology: 'sustantivo neutro',
      tags: ['espíritu', 'viento', 'aliento'],
      related: ['G4154'],
      caution: 'El contexto determina si se refiere al Espíritu de Dios, un espíritu maligno, o el espíritu humano.',
      starter: true,
    },
    {
      id: 'G2842',
      ...
      lemma: 'comunión',
      short: 'Comunión, compañerismo, participación conjunta.',
      definition: 'Comunión íntima, participación, compartir, contribución. Describe la unidad y el compartir en la iglesia.',
      beginner: 'Es el compañerismo profundo y el compartir la vida que tienen los creyentes juntos.',
      advanced: 'Sustantivo femenino. Implica una participación activa y solidaria en algo común.',
      morphology: 'sustantivo femenino',
      tags: ['comunión', 'compañerismo', 'participación'],
      related: ['G2844'],
      caution: 'Va mucho más allá del compañerismo social casual; implica asociación y compromiso.',
      starter: true,
    },
    {
      id: 'G1577',
      ...
      lemma: 'iglesia',
      short: 'Asamblea, congregación, los llamados a salir.',
      definition: 'Una asamblea de personas llamadas de sus hogares a un lugar público. En el NT, la congregación o iglesia cristiana.',
      beginner: 'Significa asamblea o congregación. Son las personas que Dios ha llamado para ser su pueblo.',
      advanced: 'Sustantivo femenino. Deriva de ek (fuera de) y kaleo (llamar). No se refiere a un edificio, sino a la gente.',
      morphology: 'sustantivo femenino',
      tags: ['iglesia', 'asamblea', 'congregación'],
      related: ['G1537', 'G2564'],
      caution: 'Nunca se usa en el NT para un edificio físico, siempre para las personas.',
      starter: true,
    },
    {
      id: 'G2316',
      ...
      lemma: 'dios',
      short: 'Dios, deidad suprema.',
      definition: 'Dios, el Creador y sustentador del universo.',
      beginner: 'La palabra general para Dios en el Nuevo Testamento.',
      advanced: 'Sustantivo masculino. Se usa principalmente para el único Dios verdadero, y ocasionalmente en el NT para referirse a la naturaleza divina de Cristo.',
      morphology: 'sustantivo masculino',
      tags: ['dios', 'creador', 'deidad'],
      related: [],
      caution: '',
      starter: true,
    },
    {
      ...
      pronunciation: 'chris-tos',
      lemma: 'cristo',
      short: 'Ungido, el Mesías.',
      definition: 'Ungido; el Mesías, el título de Jesús.',
      beginner: 'Es el título griego equivalente al Mesías en hebreo. Significa el ungido por Dios.',
      advanced: 'Adjetivo usado como sustantivo. Originalmente un título (el Cristo), se convirtió casi en un nombre propio para Jesús.',
      morphology: 'sustantivo masculino',
      tags: ['cristo', 'mesías', 'ungido'],
      related: ['G5548'],
      caution: 'Recuerda que Cristo es un título, no el apellido de Jesús.',
      starter: true,
    },
    {
      id: 'H430',
      ...
      lemma: 'Dios',
      short: 'Dios (plural majestático), dioses.',
      definition: 'Dios supremo; a veces, dioses, ángeles, jueces.',
      beginner: 'La palabra común para referirse a Dios en el Antiguo Testamento. Aunque es plural, cuando se refiere al Dios verdadero, los verbos están en singular.',
      advanced: 'Sustantivo masculino plural. Un plural intensivo o de majestad. Enfatiza la grandeza y el poder.',
      morphology: 'sustantivo masculino plural',
      tags: ['dios', 'poder', 'creador'],
      related: ['H410'],
      caution: '',
      starter: true,
    },
    {
      ...
      pronunciation: 'ya-weh',
      lemma: 'Jehová',
      short: 'El Señor, el Nombre propio de Dios.',
      definition: 'El nombre propio del Dios de Israel. A menudo traducido como SEÑOR.',
      beginner: 'El nombre personal de Dios, revelado a Moisés. Significa el que es, el que siempre existe.',
      advanced: 'Nombre propio. Relacionado con el verbo ser (H1961). Por respeto, los judíos leían Adonai en su lugar.',
      morphology: 'nombre propio',
      tags: ['señor', 'jehová', 'nombre'],
      related: ['H1961'],
      caution: 'En muchas Biblias en español se traduce como SEÑOR (todo en mayúsculas).',
      starter: true,
    },
    {
      id: 'H7225',
      ...
      pronunciation: 're-shith',
      lemma: 'principio',
      short: 'Primero (en tiempo, lugar, orden o rango), principio.',
      definition: 'Comienzo, lo primero, primicias, jefe.',
      beginner: 'Significa el principio, la primera parte de algo, o lo más importante.',
      advanced: 'Sustantivo femenino. Es la primera palabra de la Biblia (Bereshith = En el principio).',
      morphology: 'sustantivo femenino',
      tags: ['principio', 'primero', 'primicias'],
      related: ['H7218'],
      caution: '',
      starter: true,
    },
    {
      ...
      pronunciation: 'ba-ra',
      lemma: 'crear',
      short: 'Crear, hacer de la nada, dar forma.',
      definition: 'Crear, formar, hacer. En la forma Qal del verbo, solo Dios es siempre el sujeto.',
      beginner: 'Un verbo que se usa para describir el poder creativo exclusivo de Dios.',
      advanced: 'Verbo. Expresa el trabajo divino de traer algo nuevo a la existencia.',
      morphology: 'verbo',
      tags: ['crear', 'hacer'],
      related: [],
      caution: '',
